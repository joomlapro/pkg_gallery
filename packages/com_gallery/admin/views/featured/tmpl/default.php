...
$canOrder  = $user->authorise('core.edit.state', 'com_gallery.album');
$archived  = $this->state->get('filter.state') == 2 ? true : false;
$trashed   = $this->state->get('filter.state') == -2 ? true : false;
$saveOrder = $listOrder == 'fp.ordering';
?>
<form action="<?php echo JRoute::_('index.php?option=com_gallery&view=featured'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="albumList">
				...
				<tbody>
					...
					<?php foreach ($this->items as $i => $item):
						...
						$assetId    = 'com_gallery.album.' . $item->id;
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
							...
							<td class="nowrap has-context">
								<div class="pull-left">
									...
									<?php endif; ?>
									<?php if ($canEdit): ?>
										<a href="<?php echo JRoute::_('index.php?option=com_gallery&task=album.edit&return=featured&id=' . $item->id); ?>" title="<?php echo JText::_('JACTION_EDIT'); ?>"><?php echo $this->escape($item->title); ?></a>
									<?php else: ?>
